            ...
            <section className="housedetails-container">
                <div className="images-container">
                    <div className="gallery">
                        <img key={0} className="img img-1" src={this.house.imgs[0]} alt="" />
                        <img key={1} className="img img-2" src={this.house.imgs[1]} alt="" />
                        <img key={2} className="img img-3" src={this.house.imgs[2]} alt="" />
                        <img key={3} className="img img-4" src={this.house.imgs[3]} alt="" />
                        <img key={4} className="img img-5" src={this.house.imgs[4]} alt="" />
                    </div>
                </div>
            </section>
