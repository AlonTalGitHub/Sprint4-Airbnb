      ...
      <div className="home">
        ...
        <section className="lists-section-container">
          <div>
            ...
            {this.props.israel && <HouseList houses={this.props.israel}></HouseList>}
          </div>
          <div>
            <h4 className="reccomended-headline">Most reccomended in Italy</h4>
            {this.props.italy && <HouseList houses={this.props.italy}></HouseList>}
          </div>
          <div>
            <h4 className="reccomended-headline">Most reccomended in Spain</h4>
            {this.props.spain && <HouseList houses={this.props.spain}></HouseList>}
          </div>
        </section>
        {/* /* <MapMarker/> */}
      </div>
